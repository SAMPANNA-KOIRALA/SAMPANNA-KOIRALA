                    ...
                    <tr>
                        ...
                        <td width="60%">
                            <font face="arial" color="#ffffff" size="4">
                                <h2>
                                    I am a simple website creator...

                                </h2>
                                <p>My name is Sampanna Koirala.I study in grade 8.This website is designed and created by me.I did it all on my Dashain and Tihar vacation after the exam.</p>

                                <details>
                                    <summary>Read More</summary>
                                    <p>This took me a lot of time to manage the functions , codes , designs etc in the website.This website took me over 5hrs of effort.Which is less but I did it continuosly until my work was done. I took help from many social medias such as Google , YouTube , Books etc.</p>
                                    </details>                                        
                    ...
                    <tr>
                        <td width="66%" valign="top">
                           <font face="arial"color="#292929">
                            <ul>
                                <li>QUALIFICATION TILL CLASS 7</li>
                                <li>BEGGINER PROGRAMMER</li>
                                <li>Good in Computer , Nepali and English</li>
                                <li>Player of Football , Basketball , Chess , Badminton etc.</li>
                    ...
                    <tr>
                        <td width="25%" valign="top">
                            <font face="arial" color="#f3971b" size="5">
                                ...
                                Facebook =  https://www.facebook.com/profile.php?id=100069458792149
                            </font>
                    ...
                    <tr>
                        <td width="25%" valign="top">
                            <font face="arial" color="#f3971b" size="5">
                                ...
                                YouTube = https://www.youtube.com/channel/UCDSisXHfQqIHvasHkzkEtYA
                            </font>
                        ...
                        <td width="25%" valign="top">
                            <font face="arial" color="#f3971b" size="5">
                                ...
                                Email = sampannakoiralaff@gmail.com
                            </font>
